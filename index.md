...
1. Select categories from the top menu
2. Find topic-specific articles in subcategories
3. Read Markdown formatted files

### Contributing

1. Read the [CONTRIBUTING.md](https://github.com/Jonomer/fswiki/blob/main/CONTRIBUTING.md) file
2. Review [STYLE_GUIDE.md](https://github.com/Jonomer/fswiki/blob/main/STYLE_GUIDE.md) standards
